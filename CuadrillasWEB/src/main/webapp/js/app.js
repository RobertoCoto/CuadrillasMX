                      ...
                      if (status === google.maps.GeocoderStatus.OK) {
                        if (results[1]) {
                          ...
                          /*$( "#tramos" ).append( $( "<div class=\"row\""
                           + "<div class=\"col-sm-12\">"
                             + "<div class=\"form-group\">"
                               + "<label for=\"direccionInicial\" class=\"control-label\">DirecciÃ³n</label>"
                         ...
                         + "<div class=\"row\">"
                          ...
                          $('#alert').show();
                          $('#msgerror').text('No se encontro una direcciÃ³n disponible.')
                          //alert('No se encontraron resultados');
                        }
                      } else {
                        $('#alert').show();
                        $('#msgerror').text('Problemas en la geolocalizaciÃ³n debido ' + status + '')
