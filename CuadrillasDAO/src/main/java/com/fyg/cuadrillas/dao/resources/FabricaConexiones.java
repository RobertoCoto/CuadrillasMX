package com.fyg.cuadrillas.dao.resources;
...
public final class FabricaConexiones {
	...
	private static void iobtenerSesionTx() {
		...
		try {
			readerTx 		= Resources.getResourceAsReader( "com/fyg/cuadrillas/dao/resources/SqlConfigCuadrillas.xml" );
	...
	private static void iobtenerSesionNTx()	{
		...
		try {
			readerNTx 		= Resources.getResourceAsReader( "com/fyg/cuadrillas/dao/resources/SqlConfigCuadrillas.xml" );
